...
const TWITTER_HANDLE = 'Kyotaro2357';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = '';
const TOTAL_MINT_COUNT = 50;
// コトントラクトアドレスをCONTRACT_ADDRESS変数に格納
const CONTRACT_ADDRESS = "0xecD32b20Db7E64210e7a4fee4a1DA2654825B41B";
const App = () => {
  /*
  ...
  */
  const checkIfWalletIsConnected = async () => {
    ...
    // ユーザーが、Rinkeby 以外のネットワークにログインしている状態で、あなたの WEBサイトに接続しようとしたら、それを知らせるアラートを出す。
    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          ...
          alert(
            `あなたのウォレットに NFT を送信しました。Ralible に表示されるまで最大で10分かかることがあります。NFT へのリンクはこちらです: https://rinkeby.rarible.com/token/${CONTRACT_ADDRESS}/}`
          );
        });
